...
namespace CubeSimulatorGUI
{
    public partial class Form1 : Form
    {
        ...
        public void UpdateFaces(string[][] edges, string[][] corners)
        {
            rtbUFace.Clear();
            rtbUFace.Text = (corners[0][0] + "    " + edges[0][0] + "    " + corners[1][0] + "\n" + edges[3][0] + "    " + "W" + "    " + edges[1][0] + "\n" + corners[3][0] + "    " + edges[2][0] + "    " + corners[2][0]);
            rtbFFace.Clear();
            rtbFFace.Text = (corners[3][1] + "    " + edges[2][1] + "    " + corners[2][2] + "\n" + edges[6][0] + "    " + "G" + "    " + edges[5][0] + "\n" + corners[7][2] + "    " + edges[10][1] + "    " + corners[6][1]);
            rtbLFace.Clear();
            rtbLFace.Text = (corners[0][1] + "    " + edges[3][1] + "    " + corners[3][2] + "\n" + edges[7][1] + "    " + "O" + "    " + edges[6][1] + "\n" + corners[4][2] + "    " + edges[11][1] + "    " + corners[7][1]);
            rtbRFace.Clear();
            rtbRFace.Text = (corners[2][1] + "    " + edges[1][1] + "    " + corners[1][2] + "\n" + edges[5][1] + "    " + "R" + "    " + edges[4][1] + "\n" + corners[6][2] + "    " + edges[9][1] + "    " + corners[5][1]);
            rtbBFace.Clear();
            rtbBFace.Text = (corners[1][1] + "    " + edges[0][1] + "    " + corners[0][2] + "\n" + edges[4][0] + "    " + "B" + "    " + edges[7][0] + "\n" + corners[5][2] + "    " + edges[8][1] + "    " + corners[4][1]);
            rtbDFace.Clear();
            rtbDFace.Text = (corners[7][0] + "    " + edges[10][0] + "    " + corners[6][0] + "\n" + edges[11][0] + "    " + "Y" + "    " + edges[9][0] + "\n" + corners[4][0] + "    " + edges[8][0] + "    " + corners[5][0]);
        }
